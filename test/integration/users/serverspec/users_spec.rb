...
describe file('/etc/sudoers.d/zoe') do
  ...
  it { should be_owned_by 'root' }
  it { should be_grouped_into 'root' }
  it { should contain 'zoe ALL=(root) NOPASSWD:/usr/bin/chmod' }
  it { should contain 'zoe ALL=(ALL) ALL' }
end
